...
class FirestoreClient:
    ...
    # Campaign operations
    async def get_campaigns(self, user_id: str, tenant_id: str = "default", 
                           is_active: Optional[bool] = None, limit: int = 50) -> List[Dict]:
    ...
    async def get_campaign(self, campaign_id: str, user_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            if campaign_data.get("user_id") != user_id:
                logger.warning("Access denied to campaign", 
            ...
            logger.error("Error retrieving campaign", 
                        campaign_id=campaign_id, user_id=user_id, error=str(e))
            raise
    ...
    async def create_campaign(self, campaign_data: Dict) -> str:
        ...
        try:
            ...
            logger.info("Created campaign", campaign_id=campaign_id, 
    ...
    # Creative operations
    async def get_creatives(self, campaign_id: str, user_id: str, 
                           limit: int = 50) -> List[Dict]:
        """Get creatives for a campaign"""
        try:
            query = self.get_collection("creatives").where("campaign_id", "==", campaign_id)
            ...
            logger.info("Retrieved creatives", campaign_id=campaign_id, count=len(creatives))
            return creatives
            
        except Exception as e:
            logger.error("Error retrieving creatives", 
    ...
    async def create_creative(self, creative_data: Dict) -> str:
        ...
        try:
            ...
            logger.info("Created creative", creative_id=creative_id, 
    ...
    async def create_generation_job(self, job_data: Dict) -> str:
        ...
        try:
            ...
            logger.info("Created generation job", job_id=job_id, 
    ...
    async def update_generation_job(self, job_id: str, updates: Dict):
        ...
        try:
            ...
            logger.info("Updated generation job", job_id=job_id, 
                       status=updates.get("status"))
            
        except Exception as e:
            logger.error("Error updating generation job", 
    ...
    async def batch_write(self, operations: List[Dict]):
        ...
        try:
            ...
            for operation in operations:
                ...
                doc_ref = self.get_collection(collection).document(doc_id) if doc_id else self.get_collection(collection).document()
